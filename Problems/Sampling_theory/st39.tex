...
\noaddpoints
\begin{parts}
\part[7] Estime la tasa de aprobación de los hombres y de las mujeres.
\part[7] Calcule el sesgo aproximado para estas estimaciones.
\part[7] Estime el error cuadrático medio de estas tasas de aprobación.
\part[8] Calcule los intervalos de confianza al 95\% para las tasas de aprobación de hombres y mujeres. ¿Qué puede decir de sus respectivas posiciones?
\end{parts}
\begin{solution}
